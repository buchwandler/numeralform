...
_TEEN_CASES = {
    ...
    11: ("одиннадцать", "одиннадцати", "одиннадцати", ("одиннадцать", "одиннадцать"), "одиннадцатью", "одиннадцати"),
    12: ("двенадцать", "двенадцати", "двенадцати", ("двенадцать", "двенадцать"), "двенадцатью", "двенадцати"),
    13: ("тринадцать", "тринадцати", "тринадцати", ("тринадцать", "тринадцать"), "тринадцатью", "тринадцати"),
    14: ("четырнадцать", "четырнадцати", "четырнадцати", ("четырнадцать", "четырнадцать"), "четырнадцатью", "четырнадцати"),
    15: ("пятнадцать", "пятнадцати", "пятнадцати", ("пятнадцать", "пятнадцать"), "пятнадцатью", "пятнадцати"),
    16: ("шестнадцать", "шестнадцати", "шестнадцати", ("шестнадцать", "шестнадцать"), "шестнадцатью", "шестнадцати"),
    17: ("семнадцать", "семнадцати", "семнадцати", ("семнадцать", "семнадцать"), "семнадцатью", "семнадцати"),
    18: ("восемнадцать", "восемнадцати", "восемнадцати", ("восемнадцать", "восемнадцать"), "восемнадцатью", "восемнадцати"),
    19: ("девятнадцать", "девятнадцати", "девятнадцати", ("девятнадцать", "девятнадцать"), "девятнадцатью", "девятнадцати"),
}
...
_ONES = {
    0: ("ноль", "ноля", "нолю", ("ноль", "ноль"), "нолём", "ноле"),
    1: {
...
class RussianRenderer:
    ...
    def _ordinal(self, value: int, morphology) -> str:
        ...
        for exponent in sorted(_SCALE_NOM, reverse=True):
            ...
            if value >= scale:
                ...
                if group == 1:
                    return self._ordinal_scale(scale_name, case, gender, animate)
                return self._integer(group, 1, "m", animate) + self._ordinal_scale(
                    scale_name, case, gender, animate
                )
        hundreds, remainder = divmod(value, 100)
    ...
    def _ordinal_scale(self, name, case, gender, animate):
        stem = name.removesuffix("а")
        return self._ordinal_from_stem(stem + "н", case, gender, animate, "ый")
