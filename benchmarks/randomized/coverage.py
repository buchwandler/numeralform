...
def summarize_coverage(
    results: Iterable[DifferentialResult], expected: dict | None = None
) -> dict:
    ...
    return {
        ...
        "locale_kind_cells_expected": len(
            expected.get("locale_kind_cells", dimensions["locale_kind_cells"])
        ),
        "locale_kind_cells_covered": len(dimensions["locale_kind_cells"]),
        "option_profiles_expected": len(
            expected.get("option_profiles", dimensions["option_profiles"])
        ),
        "option_profiles_covered": len(dimensions["option_profiles"]),
        "currency_cells_expected": len(
            expected.get("currency_cells", dimensions["currency_cells"])
        ),
        ...
        "call_variants_expected": expected.get(
            "call_variants", dimensions["call_variants"]
        ),
        "call_variants_covered": dimensions["call_variants"],
        "numeric_boundaries_expected": expected.get(
            "numeric_boundaries", dimensions["numeric_boundaries"]
        ),
