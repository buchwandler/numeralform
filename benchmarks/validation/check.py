...
if __package__ in {None, ""}:  # support the documented ``python tools/...py`` form
    ...
    from benchmarks.validation.model import ValidationCase
    from benchmarks.validation.normalize import is_nfc
    from benchmarks.validation.report import Mismatch, format_mismatches, summarize
else:
    from .corpus import (
        CorpusError,
        load_exceptions,
